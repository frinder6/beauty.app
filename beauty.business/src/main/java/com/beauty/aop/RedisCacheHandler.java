...
/**
 * Created by frinder_liu on 2016/5/3.
 */
@Component(value = "redisCacheHandler")
public class RedisCacheHandler implements MethodInterceptor {
    ...
    private String getCacheKey(String targetName, String methodName,
        ...
        try {
            sbu.append(session.getAttribute("CURRENT_USER_ACCOUNT")).append("_");
        } catch (Exception e) {
        }
