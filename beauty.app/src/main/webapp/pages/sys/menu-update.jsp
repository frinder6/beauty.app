...
<form id="basicForm" action="${basePath }/resource/update.action" class="form-horizontal" method="post"
      onsubmit="return false;">
    <input type="hidden" name="id" value="${param.id }"/>

    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">更新导航</h4>
        </div>
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <textarea name="remark" type="textarea" rows="5" class="form-control" placeholder="Type please..."
                              required></textarea>
                </div>
            </div>
        </div>
