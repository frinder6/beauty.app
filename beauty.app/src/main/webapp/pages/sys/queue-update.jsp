...
<form id="basicForm" action="${basePath }/queue/update.action" class="form-horizontal" method="post"
      onsubmit="return false;">
    <input type="hidden" name="id" value="${param.id }"/>

    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">更新队列</h4>
        </div>
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="queueName" class="form-control" placeholder="Type please..." required
                           ng-model="remark"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="routingKey" class="form-control" placeholder="Type please..." required
                           ng-model="remark"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <select id="pselect" name="type" required placeholder="Type please...">
                        <option value="1" selected="selected">DIRECT</option>
