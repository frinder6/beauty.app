...
<body style="background-color: #E4E7EA;">
	...
	<form id="basicForm" action="${basePath }/user/update.action" class="form-horizontal" method="post" onsubmit="return false;">
		<input type="hidden" name="id" value="${param.id }" />
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="panel-title">更新用户</h4>
			</div>
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="tel" name="mobile" class="form-control" placeholder="Type please..." required />
					</div>
				</div>
