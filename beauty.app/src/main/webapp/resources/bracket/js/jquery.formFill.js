					...
					try {
						...
						try {
							...
							if (options.styleElementName == "object") {
								...
								if (nameValue.match(/\[[0-9]*\]/i)) {
									objName = nameValue.replace(/^[a-z]*[0-9]*[a-z]*\./i, 'obj.').replace(/\[[0-9]*\].*/i, "");
									
									arrayAtribute = nameValue.match(/\[[0-9]*\]\.[a-z0-9]*/i) + "";
									arrayAtribute = arrayAtribute.replace(/\[[0-9]*\]\./i, "");
								} else {
									objName = nameValue.replace(/^[a-z]*[0-9]*[a-z]*\./i, 'obj.');
								}
							} else if (options.styleElementName == "none") {
								objName = 'obj.' + nameValue;
							}
